...
import { deleteTodo, selectTodoById, toggleTodo } from "../todoSlice";
...
const handleDelete =()=>{
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 flex items-center group opacity-70">
      ...
      <button onClick={handleDelete} className="text-gray-400 hover:text-accent opacity-0 group-hover:opacity-100 transition">
